...
const Footer = () => {
  ...
  const BLOCKSCOUT_LINKS = [
    ...
    },
    {
      ...
      iconSize: '18px',
      text: 'Github',
      url: 'https://github.com/Cybria-Chain',
    },
    {
    ...
    },
    {
      ...
      iconSize: '24px',
      text: 'Medium',
      url: 'https://medium.com/@cybrialayer2',
    },
    {
      icon: 'donate' as const,
      iconSize: '20px',
      text: 'Donation',
      url: 'https://cybascan.io/address/0x5C648d14bc8b0D2f9aba70692b5df03EEB277E15',
    },
  ];
  ...
  const renderProjectInfo = React.useCallback((gridArea?: GridProps['gridArea']) => {
    return (
      <Box gridArea={ gridArea }>
        <Link fontSize="xs" href="https://www.cybascan.io">cybascan.io</Link>
        <Text mt={ 3 } fontSize="xs">
          Cybascan is a tool for inspecting and analyzing CYBA based blockchains. Blockchain explorer for Cybria Chain Networks.
        </Text>
    ...
    return (
      <Grid { ...containerProps }>
        ...
        >
          {
            ([
              { title: 'Cybascan', links: BLOCKSCOUT_LINKS },
              ...(linksData || []),
            ])
              .slice(0, colNum)
              .map(linkGroup => (
